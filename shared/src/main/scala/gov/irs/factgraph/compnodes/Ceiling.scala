...
private final class RationalCeilingOperator extends UnaryOperator[Int, Rational]:
...
private final class IntegerCeilingOperator extends UnaryOperator[Int, Int]:
