...
case class Address(
  ...
  try {
    ...
    // The MeF requirement for 35 characters:
    // https://github.com/usds/direct-file/blob/3f1a780cdf40d6e330c2b434222793d0252fce41/direct-file/mef-tests/src/main/resources/xsd/2022v5.2/Common/efileTypes.xsd#L678
    precondition(
